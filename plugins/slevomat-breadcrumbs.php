...
class SlevomatBreadcrumbs
{
    ...
    private static $servers = [
        'Slevomat' => [
            'daisy.stable.cz' => 'daisy.stable.cz (master)',
            'daisy.stable.cz:3307' => 'daisy.stable.cz:3307 (master)',
            'kacka.stable.cz' => 'kacka.stable.cz (secondary)',
            'kacka.stable.cz:3307' => 'kacka.stable.cz:3307 (secondary)',
            'rampa.stable.cz' => 'rampa.stable.cz (delayed slave)',
            'rampa.stable.cz:3307' => 'rampa.stable.cz:3307 (delayed slave)',
